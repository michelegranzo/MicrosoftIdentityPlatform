...
namespace MicrosoftIdentityPlatform.Controllers
{
            ...
            if (accounts.Any())
            {
                ...
                catch (MsalUiRequiredException)
                {
                    ...
                    {// when failing, manufacture the URL and assign it
                        string authReqUrl = await Utils.OAuth2RequestManager.GenerateAuthorizationRequestUrl(scopes, cca, this.HttpContext, Url);
